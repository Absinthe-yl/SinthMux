...
export default function SessionPanel({ deviceId, online, canManage, canClose, canOpen, onOpen }: { deviceId: string; online: boolean; canManage: boolean; canClose: boolean; canOpen: boolean; onOpen: (session: string) => void }) {
